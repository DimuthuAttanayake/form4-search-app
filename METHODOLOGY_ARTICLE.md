...
I wrote the pipeline in Python, with requests and BeautifulSoup for the scraping, pandas and SQLite for the database, and Flask for the site, which is hosted on Render. I used Claude, Anthropic's AI assistant, to help write and debug the code and to help draft this methodology. I reviewed and edited everything it produced, and I verified the numbers in this article against the underlying data myself.
